...
Create one self-contained CoPet global sound pack under `$HOME/.copet/sounds/<sound-pack-id>/`. This skill never creates sticker packs, sprite atlases, omni directional body atlases, pet packages, or `pet.json`.
